...
List<TechniqueInfo> fishTechniqueExamples() => [
      TechniqueInfo(
        ...
        walkthrough: '本例中数字 6 在第 3 行和第 7 行都只能出现在第 5 列和第 8 列，'
            '这两行、两列组成一个 X-Wing：无论 6 具体落在哪一种对角组合上，'
            '第 5 列和第 8 列的 6 都必然被这两行占用，因此可以把这两列其它行的候选 6 '
            '删除。本例删掉的是第 1 行第 5 列、第 1 行第 8 列、第 9 行第 5 列、'
            '第 9 行第 8 列的候选 6。',
      ...
      TechniqueInfo(
        ...
        walkthrough: '本例中数字 2 在第 2、3、4、5 行都只落在第 2、3、4、5 列，'
            '这四行合起来正好把数字 2 锁在这四列里，因此可以删除这四列上其它行的候选 2：'
            '本例删掉的是第 6 行第 2、3、4、5 列的候选 2。',
      ...
      TechniqueInfo(
        ...
        walkthrough: '本例中数字 2 在第 8 行只能出现在第 4 列和第 5 列；中心宫'
            '（第 4-6 行、第 4-6 列）里，这个数字的候选恰好也只落在第 4 列'
            '（第 4 行）和第 5 列（第 4、5 行）这两处。第 8 行和这个宫合起来'
            '正好把数字 2 锁在第 4 列、第 5 列里，因此可以删除第 1 行第 4、5 列、'
            '第 3 行第 4、5 列、第 7 行第 5 列的候选 2。',
