...
class TechniqueCatalog {
  ...
  static const practicePuzzles = <String, String>{
    ...
    // 连点提示第 13 手报唯一矩形 3：c8 上例外候选和另一格凑成 {3,4,9} 三数组。
  ...
  /// finder 报出来的技巧名 → 教学目录里的规范名。
  ///
  /// 目录名跟着评审总表走，而各 finder 里写的是更长的旧名字，它会原样出现在
  /// 提示气泡和难度分析的技巧列表里。两处名字都有人看，不好硬统一成一个，
  /// 所以 finder 侧不动，这里补一层别名，保证按 finder 报出的名字仍然
  /// 查得到对应教学条目。
