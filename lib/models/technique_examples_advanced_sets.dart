...
List<TechniqueInfo> advancedSetTechniqueExamples() => [
      TechniqueInfo(
        ...
        walkthrough: '本例考察数字 7，是一条 Franken Swordfish。'
      ...
      TechniqueInfo(
        ...
        definition: '中文术语表里的 WALS 是「弱待定数组」，指隐性一侧的待定数组'
            '（Almost Hidden Set）：一个区域里挑 N 个数字，'
      ...
      TechniqueInfo(
        ...
        howToSpot: '先看 Sue de Coq 和 DDS 这些有固定形状的特例，它们才有得找。'
            '真要认 MSLS，就逐个数字配区域、把链接条数和格数摆在一起数，'
        ...
        structure: const TeachingStructure(
          ...
          // 9 一个数字吃掉 r7 与 c8 两个区域，这是 MSLS 比 DDS 一般的地方。
          sectorLinks: [
            SectorLink(3, [6]),
            SectorLink(7, [6]),
            SectorLink(9, [6, 16]),
      ...
      TechniqueInfo(
        ...
        walkthrough: '本例是 Ruud top50000 第 12235 题的开局。'
            ...
            '2 在 S 格上出现于 r1c5、r1c7、r8c3、r8c5——r1 与 r8 两条行就覆盖了；'
